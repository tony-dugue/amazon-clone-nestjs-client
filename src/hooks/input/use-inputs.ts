...
import {InputActionType, INPUT_ACTION_CHANGE, INPUT_ACTION_BLUR, INPUT_ACTION_CLEAR} from "./models/InputAction";
...
const useInput = (validatorFn?: ValidatorFn) => {
  ...
  return { text, shouldDisplayError, textChangeHandler, inputBlurHandler, clearHandler }
}
